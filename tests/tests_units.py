...
from units.functions import open_json, sort_data, mask_number_card
...
def test_mask_number_card(sort_number_card, fixture_number_card):
    assert mask_number_card(sort_number_card) == fixture_number_card